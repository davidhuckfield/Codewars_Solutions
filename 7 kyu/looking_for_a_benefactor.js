...
//find the value of the next donation that would make the average 30
...
function newAvg(arr, newavg) {
    ...
    //the amount he wants to reach is the number of donations x 30, thereby making 30 the avg. donation
